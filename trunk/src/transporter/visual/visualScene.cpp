...
{	
	...
	//SceneNode* node_sky = game->visualSystem.getSceneMgr()->getRootSceneNode()->createChildSceneNode("sky");
	//Entity* ent_sky = game->visualSystem.getSceneMgr()->createEntity( "sky", "sphere.mesh" );
	//ent_sky->setMaterialName("HDRSky");
	//node_sky->attachObject( ent_sky );
	//node_sky->scale(Vector3(5000.,5000.,5000.));
