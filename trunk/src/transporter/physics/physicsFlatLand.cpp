...
PhysicsFlatLand::PhysicsFlatLand(int side)
{
	m_side = side;
...
PhysicsFlatLand::~PhysicsFlatLand()
{
}
...
hkReal PhysicsFlatLand::getBorderHeight()
{
	return m_borderHeight;
}


void PhysicsFlatLand::setBorderHeight( hkReal borderHeight )
{
	m_borderHeight = borderHeight;
}


void PhysicsFlatLand::setScaling( const hkVector4& scaling )
{
	m_scaling = scaling;
}

void PhysicsFlatLand::setTriangleRadius( const hkReal s )
{
	m_triangleRadius = s;
}

void PhysicsFlatLand::enableCachedBuild( hkBool enable )
{
	m_cachedBuildEnabled = enable;
}

void PhysicsFlatLand::setupVertexAndTriangleData()
{
	//
...
hkpExtendedMeshShape* PhysicsFlatLand::createExtendedMeshShape()
{
...
hkpMoppBvTreeShape* PhysicsFlatLand::createMoppShapeForSpu()
{
...
hkpMoppBvTreeShape* PhysicsFlatLand::createMoppShape()
{
...
hkpMoppBvTreeShape* PhysicsFlatLand::createMoppShape(hkpShapeCollection* meshShape)
{
...
hkpMoppBvTreeShape* PhysicsFlatLand::createMoppShapeForSpu(hkpShapeCollection* meshShape)
{
	hkpMoppCompilerInput mci;
	{
		mci.m_cachePrimitiveExtents	 = m_cachedBuildEnabled;
...
static LandscapeContainer* createFlatLand( const int landscapeSize, const hkVector4& scaling )
{
	...
	landscapeContainer->m_flatland = new PhysicsFlatLand(landscapeSize);
...
{
#if defined(HK_PLATFORM_PS2) || defined(HK_PLATFORM_GC) || defined( HK_PLATFORM_PSP)
