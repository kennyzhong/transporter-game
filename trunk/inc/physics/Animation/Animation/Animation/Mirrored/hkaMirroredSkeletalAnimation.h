...
class hkaMirroredSkeletalAnimation : public hkaSkeletalAnimation
{
	public:
		...
		hkaMirroredSkeletalAnimation( const hkaSkeletalAnimation* originalAnimation,
									 const hkaAnimationBinding* originalBinding,
									 const hkaMirroredSkeleton* mirroredSkeleton );

		~hkaMirroredSkeletalAnimation();
	...
	private:
		...
		const hkaSkeletalAnimation *m_originalAnimation;
		...
		const hkaMirroredSkeleton *m_mirroredSkeleton;
			...
			/// This is a copy of original binding hint for easy DMAing ('Additive' animations should not mirror the root).
