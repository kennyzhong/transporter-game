...
/// hkaWaveletSkeletalAnimation meta information
extern const class hkClass hkaWaveletSkeletalAnimationClass;
...
class hkaWaveletSkeletalAnimation : public hkaSkeletalAnimation
{
	public:
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_COMPRESSED, hkaWaveletSkeletalAnimation::CompressionParams );
			HK_DECLARE_REFLECTION();
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_COMPRESSED, hkaWaveletSkeletalAnimation::PerTrackCompressionParams );

			/// List of CompressionParams to enable per-bone compression settings
			/// On initialisation only a single element is allocated. 
			hkArray<struct hkaWaveletSkeletalAnimation::CompressionParams> m_parameterPalette;
		...
		hkaWaveletSkeletalAnimation(const hkaInterleavedSkeletalAnimation& raw, const CompressionParams& params, hkBool useThreeComponentQuaternions = true );

		    /// Constructor allowing different compression settings for each track in the animation
		hkaWaveletSkeletalAnimation(const hkaInterleavedSkeletalAnimation& raw, const PerTrackCompressionParams& params, hkBool useThreeComponentQuaternions = true );
	...
	public:
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIMATION, hkaWaveletSkeletalAnimation::QuantizationFormat );
			HK_DECLARE_REFLECTION();
	...
	public:
		...
		HK_FORCE_INLINE hkaWaveletSkeletalAnimation( hkFinishLoadedObjectFlag flag ) : hkaSkeletalAnimation(flag),
	...
	private:
		...
		void initialize(const hkaInterleavedSkeletalAnimation& raw, const PerTrackCompressionParams& params, hkBool useThreeComponentQuaternions);
