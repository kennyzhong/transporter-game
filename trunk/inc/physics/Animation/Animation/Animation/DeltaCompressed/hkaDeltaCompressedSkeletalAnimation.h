...
/// hkaDeltaCompressedSkeletalAnimation meta information
extern const class hkClass hkaDeltaCompressedSkeletalAnimationClass;
...
class hkaDeltaCompressedSkeletalAnimation : public hkaSkeletalAnimation
{
	public:
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_COMPRESSED, hkaDeltaCompressedSkeletalAnimation::CompressionParams );
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_COMPRESSED, hkaDeltaCompressedSkeletalAnimation::PerTrackCompressionParams );

			/// List of CompressionParams to enable per-bone compression settings
			hkArray<struct hkaDeltaCompressedSkeletalAnimation::CompressionParams> m_parameterPalette;
		...
		hkaDeltaCompressedSkeletalAnimation(const hkaInterleavedSkeletalAnimation& rawData, const CompressionParams& params, hkBool useThreeComponentQuaternions = true );

		    /// Constructor allowing different compression settings for each track in the animation
		hkaDeltaCompressedSkeletalAnimation(const hkaInterleavedSkeletalAnimation& rawData, const PerTrackCompressionParams& params, hkBool useThreeComponentQuaternions = true );
	...
	public:
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIMATION, hkaDeltaCompressedSkeletalAnimation::QuantizationFormat );
			HK_DECLARE_REFLECTION();
	...
	public:
		...
		HK_FORCE_INLINE hkaDeltaCompressedSkeletalAnimation( hkFinishLoadedObjectFlag flag ) : hkaSkeletalAnimation(flag)
	...
	private:
		...
		void initialize(const hkaInterleavedSkeletalAnimation& rawData, const PerTrackCompressionParams& params, hkBool useThreeComponentQuaternions );
