...
class hkaSkeletonUtils
{
	public:
		...
		static hkResult HK_CALL bindByName(const hkaSkeleton& skeleton, const class hkaSkeletalAnimation& anim, hkStringCompareFunc compare, class hkaAnimationBinding& bindingOut);
};
