...
// A utility to handle the collision dispatch table on SPU
class hkpSpuCollideUtil
{
	public:

		static void HK_CALL initializeCollisionDispatcher(void* weldingTableOnPpu, hkCollisionDispatcherPpu* dispatcherInMainMemory, hkpCollisionDispatcher* localDispatcher);
