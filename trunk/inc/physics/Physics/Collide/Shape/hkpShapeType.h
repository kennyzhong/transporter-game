...
enum hkpShapeType
{
	...
	HK_SHAPE_EXTENDED_MESH,
		...
		/// Reserved type for user implemented hkpShapeCollection.  See Playstation 3 Platform Guide for more details.
	HK_SHAPE_USER_SPU_COLLECTION_0,
	...
	HK_SHAPE_MAX_ID_SPU = HK_SHAPE_USER_SPU_COLLECTION_0,
