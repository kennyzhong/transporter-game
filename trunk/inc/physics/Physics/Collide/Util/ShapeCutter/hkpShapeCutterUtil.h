...
class hkpShapeConnectedCalculator : public hkReferencedObject
{
	...
	protected:
        ...
        static hkReal HK_CALL calculateClosestDistance( hkpCollisionDispatcher* dispatcher, const hkpShape* a, const hkTransform& transA, const hkpShape* b, const hkTransform& transB, hkReal maxDistance);
...
class hkpShapeCutterUtil
{
	public:
		...
		static hkpConvexVerticesShape* HK_CALL createCylinderConvexVerticesShape(hkReal radius, const hkVector4& v0, const hkVector4& v1, int numSegs);
            ...
            /// Creates a new shape, which is shape cut by the plane 'plane'
        ...
        static const hkpShape* HK_CALL cut(const hkpShape* shape, const hkVector4& plane);
