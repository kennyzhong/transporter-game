...
#     include <Common/Base/System/Io/Reader/GameCube/hkGameCubeDvdStreamReader.h>
#     include <Common/Base/System/Io/Directory/GameCube/hkGameCubeListDirectory.h>

#if defined(HK_PLATFORM_RVL)
#	include <Common/Base/System/Io/Writer/Wii/hkWiiStreamWriter.h>
#else
...
#elif defined(HK_PLATFORM_PSP) || defined(HK_PLATFORM_PS2) || defined(HK_PLATFORM_UNIX) ||  defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_MACPPC)
...
#	if defined (HK_PLATFORM_UNIX) ||  defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_MACPPC)
