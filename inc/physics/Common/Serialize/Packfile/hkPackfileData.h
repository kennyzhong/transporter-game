...
class hkPackfileData : public hkResource
{
	...
	public:
		...
		void trackObject(void* o, const hkTypeInfo *t) { m_hasEverTrackedObjects = true; m_trackedObjects.insert(o, t); }

			// Return true if has ever tracked objects
		hkBool32 hasEverTrackedObjects() const;
	...
	protected:
		...
		char* m_name;
		hkBool32 m_hasEverTrackedObjects;
