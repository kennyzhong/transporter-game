...
class hkaTrackAnalysis
{
	public:
		...
		static void HK_CALL calcStats(const hkUint16* staticMask, hkUint32 numTracks, hkUint32 numFTracks, AnalysisStats& out);

			/// This method computes information for the dynamic tracks
		static void HK_CALL calcDynamicStats(const hkUint16* staticMask, hkUint32 numTracks, hkUint32 numFTracks, AnalysisStats& out);
		...
		static void HK_CALL recompose(const AnalysisCompose& input, const hkReal* dynamicData, hkQsTransform* outputPose, hkReal* outputFloatTracks);
