...
void hkaSplineSkeletalAnimation::recompose( hkUint8 mask, const hkVector4& S, const hkVector4& I, hkVector4& inOut )
{
...
hkUint8 hkaSplineSkeletalAnimation::read8( const hkUint8*& dataInOut )
{
	return *dataInOut++;
}
...
/// \param dataInOut Buffer which is incremented
hkUint16 hkaSplineSkeletalAnimation::read16( const hkUint8*& dataInOut )
{
...
/// \param dataInOut Buffer which is incremented
hkReal hkaSplineSkeletalAnimation::readReal( const hkUint8*& dataInOut )
{
...
void hkaSplineSkeletalAnimation::readAlign( int align, const hkUint8*& dataInOut )
{
...
void hkaSplineSkeletalAnimation::readAlignQuaternion( TrackCompressionParams::RotationQuantization type, const hkUint8*& dataInOut )
{
...
/// \param type The type of quaternion compression to use
int hkaSplineSkeletalAnimation::bytesPerQuaternion( TrackCompressionParams::RotationQuantization type )
{
	HK_ASSERT2( 0x3aa3eb74, TrackCompressionParams::validQuantization( type ), "Spline data corrupt." );
...
/// \param type The type of quaternion compression to use
int hkaSplineSkeletalAnimation::bytesPerComponent( TrackCompressionParams::ScalarQuantization type )
{
	HK_ASSERT2( 0x3aa3eb74, TrackCompressionParams::validQuantization( type ), "Spline data corrupt." );
...
hkReal hkaSplineSkeletalAnimation::unpack16( hkReal minp, hkReal maxp, hkUint16 val )
{
...
void hkaSplineSkeletalAnimation::unpackQuantizationTypes( hkUint8 packedQuatizationTypes, TrackCompressionParams::ScalarQuantization& translation, TrackCompressionParams::RotationQuantization& rotation, TrackCompressionParams::ScalarQuantization& scale )
{
...
void hkaSplineSkeletalAnimation::unpackMaskAndQuantizationType( hkUint8 packedMaskAndQuatizationType, hkUint8& mask, TrackCompressionParams::ScalarQuantization& floatQuantization )
{
...
/// \param maxp Maximum expected value
/// \param Packed value to expand
hkReal hkaSplineSkeletalAnimation::unpack8( hkReal minp, hkReal maxp, hkUint8 val )
{
...
void hkaSplineSkeletalAnimation::unpackQuaternion( TrackCompressionParams::RotationQuantization type, const hkUint8* in, hkQuaternion* out )
{
...
void hkaSplineSkeletalAnimation::evaluate( hkReal u, int p, hkReal U[ MAX_DEGREE * 2 ], hkVector4 P[ MAX_ORDER ], hkVector4& out )
{
...
int hkaSplineSkeletalAnimation::findSpan( int n, int p, hkUint8 u, const hkUint8* U )
{
	// Bounds protect
...
void hkaSplineSkeletalAnimation::getBlockAndTime( hkReal time, int& blockOut, hkReal& blockTimeOut, hkUint8& quantizedTimeOut ) const
{
