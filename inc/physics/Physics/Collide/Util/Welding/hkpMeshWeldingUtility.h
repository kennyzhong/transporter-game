...
class hkpMeshWeldingUtility
{
	...
	public:
		...
		static hkUint16 HK_CALL calcWeldingInfoForTriangle( hkpShapeKey shapeKey, const hkpBvTreeShape* bvTreeShape, bool testConsistantWinding = false );

			/// A function to check if winding is correct for a triangle.			
