...
struct hkpMultithreadingUtilCinfo
{
	...
	int m_numThreads;
		...
		/// integer array to specify the Xbox360 Processor Thread to run WorkerThread with threadId 
    hkArray<int> m_threadIdToProcThread;
#endif
	...
	public:
		...
		struct State
		{
			...
			hkSemaphore m_asyncFinishSemaphore;
				...
				/// An additional semaphore used for avoiding preemption issues.
			hkSemaphore m_physicsBarrierSemaphore;
